...
host = 'localhost'
user = 'root'
password = '9688440042@KD'
mydb = pymysql.connect(host='localhost', user='root', password='9688440042@KD')
...
st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://previews.123rf.com/images/virtosmedia/virtosmedia2303/virtosmedia230313916/199713962-stacks-of-gold-coins-on-wooden-table-3d-illustration.jpg");
  ...
  # Get the name of the selected business card
   ...
   # Create a button to confirm the deletion of the selected business card
    if st.button("Delete Business Card"):
        ...
        st.caption("Made with 🤩 by @DINESH K")
